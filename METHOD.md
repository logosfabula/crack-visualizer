...
**If a floor's oldest reading is (0,0) and the floor's crack meter is marked as standard (non-inverse), the floor's normalized readings are the same as the floor's raw readings. Installing crack-meters to comply to both is advised, but not mandatory, as the software applies normalization for your convenience.**
