...
![Version](https://img.shields.io/badge/version-0.15.16-blue)
...
The flags for standard/inverted interpretations of each floor are harcoded in the main component at current version (v0.15.16)
